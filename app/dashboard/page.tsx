...
async function updateProfile(formData: FormData) {
  ...
  const workspaceUid = String(formData.get("workspace_uid") ?? "").trim();
  ...
  await adminSupabase
    ...
    .update({
      ...
      workspace_uid: workspaceUid || null,
    })
    .eq("id", user.id);
...
async function updatePassword(formData: FormData) {
  ...
  redirect("/dashboard?password=success");
}
...
export default async function DashboardPage({
  ...
  > = {
    ...
    failed: {
      type: "error",
      text: "Unable to change your password. Please try again.",
    },
  };

  const passwordMessage =
    password && passwordMessages[password]
      ? passwordMessages[password]
      : null;
  ...
  return (
    <main className="min-h-screen bg-[#080808] text-white">
        ...
        <div className="mx-auto flex h-18 max-w-360 items-center justify-between px-6 lg:px-10">
          ...
          <div className="flex items-center gap-3">
            {profile?.role === "admin" && (
              <Link
                href="/admin"
                className="flex h-10 items-center border border-orange-400/30 px-4 text-[9px] font-semibold uppercase tracking-[0.15em] text-orange-400 transition hover:bg-orange-400/8"
              >
                Admin Panel
              </Link>
            )}
      ...
      <div className="border-b border-white/[0.07] bg-[#0a0a0a]">
        <div className="mx-auto flex h-11 max-w-360 items-center justify-between px-6 lg:px-10">
          <div className="flex items-center gap-3">
      ...
      <section className="mx-auto max-w-360 px-6 py-10 lg:px-10">
        ...
        <div className="grid gap-5 lg:grid-cols-[280px_1fr]">
          <aside className="border border-white/8 bg-[#0c0c0c]">
            <div className="border-b border-white/8 p-6">
              <div className="flex items-center gap-4">
                {profile?.avatar_url ? (
                  ...
                  <div className="flex h-16 w-16 items-center justify-center border border-white/10 bg-[#151515] text-lg font-semibold text-orange-400">
                    {initials}
                  </div>
                )}
          ...
          <section className="border border-white/8 bg-[#0c0c0c]">
              ...
              <div className="grid gap-5 md:grid-cols-2">
                <label className="block">
                  ...
                  <input
                    ...
                    className="mt-2 h-11 w-full border border-white/10 bg-[#111111] px-3 text-sm text-zinc-200 outline-none transition placeholder:text-zinc-700 focus:border-orange-400/50"
                  />
                </label>
                ...
                <label className="block">
                  ...
                  <input
                    ...
                    value={email}
                    readOnly
                    className="mt-2 h-11 w-full cursor-not-allowed border border-white/6 bg-[#0a0a0a] px-3 text-sm text-zinc-500 outline-none"
                  />
              ...
              <div className="grid gap-5 md:grid-cols-2">
                <label className="block">
                  ...
                  <input
                    name="workspace_name"
                    type="text"
                    defaultValue={profile?.workspace_name ?? ""}
                    maxLength={100}
                ...
                <label className="block">
                  ...
                  <input
                    name="workspace_uid"
                    type="text"
                    defaultValue={profile?.workspace_uid ?? ""}
                    maxLength={100}
                    placeholder="Workspace identifier"
                    className="mt-2 h-11 w-full border border-white/10 bg-[#111111] px-3 font-mono text-xs text-zinc-200 outline-none transition placeholder:text-zinc-700 focus:border-orange-400/50"
                  />
                </label>
              </div>
        ...
        <div className="mt-5 grid gap-5 md:grid-cols-3">
          <div className="border border-white/8 bg-[#0c0c0c] p-5">
            <p className="text-[9px] uppercase tracking-[0.18em] text-zinc-700">
              Account ID
            </p>

...
export const metadata: Metadata = {
  title: "Docs",
  description:
    "Developer documentation for integrating applications with AWS LPU SSO using OAuth 2.0 and OpenID Connect.",
  openGraph: {
    title: "Docs | AWS LPU SSO",
    description:
      "Developer documentation for AWS LPU Identity Services.",
...
function Step({
  ...
  return (
    <section className="scroll-mt-24 border-b border-white/8 py-10">
      <div className="flex gap-6">
        ...
        <div className="min-w-0 flex-1">
          <h2 className="text-2xl font-semibold tracking-[-0.025em] text-zinc-100">
            {title}
          </h2>
  ...
  return (
    <main className="min-h-screen bg-[#08090b] text-white">
      <div className="pointer-events-none fixed inset-0">
        <div className="absolute left-[20%] top-[-300px] h-[600px] w-[800px] rounded-full bg-orange-500/5 blur-[180px]" />
          ...
          <div className="flex items-center gap-5">
            ...
            {user ? (
              <>
                ...
                <Link
                  href="/dashboard"
                  className="flex h-10 w-10 items-center justify-center overflow-hidden border border-white/12 bg-white/3 transition hover:border-orange-400/50"
                >
                  {avatarUrl ? (
                    <img
                      src={avatarUrl}
      ...
      <div className="relative z-10 mx-auto grid max-w-[1500px] grid-cols-1 border-x border-white/6 lg:grid-cols-[270px_minmax(0,1fr)]">
        <aside className="hidden border-r border-white/8 lg:block">
          <div className="sticky top-[76px] p-7">
        ...
        <div className="min-w-0">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="h-7 w-[3px] bg-orange-400" />
            ...
            <p className="mt-6 max-w-2xl text-base leading-7 text-zinc-500">
              Connect your application to AWS LPU Identity
              Services and let users sign in using one AWS
              LPU account.
            </p>
          ...
          <div className="px-6 lg:px-14">
            ...
            >
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-2">
                {[
                  ...
                  ["04", "Exchange the code for identity"],
                ].map(([number, title]) => (
                  <div
                    key={number}
            ...
            <div id="register">
              ...
              >
                <p className="max-w-2xl text-sm leading-7 text-zinc-500">
                  Register your application and configure
                  the exact URL where users should return
                  after signing in.
                </p>
            ...
            <div id="login">
              ...
              >
                <p className="text-sm leading-7 text-zinc-500">
                  ...
                  endpoint with your application details.
                </p>
                ...
                <div className="mt-7 grid gap-3 md:grid-cols-2">
                  <div className="border border-white/8 p-5">
                    ...
                    <p className="mt-2 text-xs leading-6 text-zinc-600">
                      The Client ID generated when you
                  ...
                  <div className="border border-white/8 p-5">
                    ...
                    <p className="mt-2 text-xs leading-6 text-zinc-600">
                      Must exactly match a redirect URL
                  ...
                  <div className="border border-white/8 p-5">
                    ...
                    <p className="mt-2 text-xs leading-6 text-zinc-600">
                      A random value created before login
                      and verified after the user returns.
                    </p>
                  </div>
                  ...
                  <div className="border border-white/8 p-5">
                    ...
                    <p className="mt-2 text-xs leading-6 text-zinc-600">
                      Security values generated before
            ...
            <div id="callback">
              ...
              >
                <p className="text-sm leading-7 text-zinc-500">
                  After the user signs in, AWS LPU SSO
                  redirects them back to your registered
                  redirect URL.
                </p>
                ...
                <p className="mt-6 text-sm leading-7 text-zinc-500">
                  ...
                  the value created before login. Then use
                  the authorization code to get the user's
                  identity.
                </p>
              </Step>
            </div>
            ...
            <div id="token">
              ...
              >
                <p className="text-sm leading-7 text-zinc-500">
                  Send the authorization code to the token
              ...
              <div className="flex gap-6">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-5 text-sm leading-7 text-zinc-500">
                    Use the access token to get the
...
Authorization: Bearer ACCESS_TOKEN`}</CodeBlock>
                  ...
                  <p className="mt-6 text-sm leading-7 text-zinc-500">
                    ...
                    the user information can include their
                    identity, name, email, and profile
                    picture.
                  </p>
  ...
  "picture": "https://..."
            ...
            >
              ...
              <p className="mt-4 text-sm leading-7 text-zinc-500">
                Use these endpoints when integrating your
                application with AWS LPU Identity Services.
              </p>

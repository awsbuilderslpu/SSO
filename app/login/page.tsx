...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-[#080808] text-white">
      ...
      <div className="mx-auto grid min-h-[calc(100vh-72px)] max-w-360 lg:grid-cols-[1fr_1px_1fr]">
        <section className="hidden flex-col justify-center px-10 py-16 lg:flex xl:px-20">
          <div className="max-w-xl">
            ...
            <p className="mt-8 max-w-lg border-l border-white/10 pl-5 text-sm leading-7 text-zinc-500">
              Authenticate once and securely access connected AWS LPU
              applications using a centralized identity.
            </p>

            <div className="mt-12 grid grid-cols-2 border border-white/8 bg-[#0d0d0d]">
              ...
              <div className="border-t border-r border-white/8 p-5">
                <p className="text-[10px] uppercase tracking-[0.18em] text-zinc-600">
                  Identity
                </p>
        ...
        <section className="flex items-center justify-center px-5 py-12 sm:px-8">
          <div className="w-full max-w-110">
            <div className="border border-white/10 bg-[#0d0d0d] shadow-2xl shadow-black/30">
              <div className="border-b border-white/8 px-7 py-6 sm:px-8">
                <div className="flex items-start justify-between gap-6">
                  ...
                  <div className="flex h-8 w-8 items-center justify-center border border-orange-400/20 bg-orange-400/5">
              ...
              <div className="px-7 py-7 sm:px-8">
                ...
                <button
                  ...
                  className="flex h-12 w-full items-center justify-center gap-3 border border-white/12 bg-[#111111] px-4 text-sm font-medium text-zinc-200 transition hover:border-white/22 hover:bg-[#151515] disabled:cursor-not-allowed disabled:opacity-50"
                >
                  {googleLoading ? (
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      disabled={loading || googleLoading}
                      required
                      className="h-12 w-full border border-white/10 bg-[#090909] px-4 text-sm text-white outline-none transition placeholder:text-zinc-700 focus:border-orange-400/60 focus:bg-[#0b0b0b] disabled:opacity-50"
                    />
                  </div>
              ...
              <div className="border-t border-white/8 bg-[#0a0a0a] px-7 py-4 sm:px-8">
